...
tags: dds ros2 communication
categories: Robotics
thumbnail: assets/img/dds_ros2/thumbnail.png
featured: true
---
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/dds_ros2/mqtt-protocol3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/dds_ros2/dds-entity.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/dds_ros2/BuiltinWritersAndReaders.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/dds_ros2/SDP-image.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
